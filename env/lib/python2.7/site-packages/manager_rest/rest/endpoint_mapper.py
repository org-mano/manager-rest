...
def setup_resources(api):
    ...
    api.add_resource(resources_v1.Grant, '/v1/resource/grant', endpoint='grant')
    api.add_resource(resources_v1.LifeCycleChangesNotification, '/v1/vnfs/lifecyclechangesnotification', endpoint='lifecyclechangesnotification')
    api.add_resource(resources_v1.EventNotification, '/v1/vnfs/eventnotification', endpoint='eventnotification')
