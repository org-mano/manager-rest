...
def setup_resources(api):
    resources_endpoints = {
	    'Insts': 'insts',
        'Vims': 'vims',
        'VimsId': 'vims/<string:vim_id>',
        'Vnf_pkgs': 'vnf_pkgs',
        'Vnf_pkgsId': 'vnf_pkgs/<string:vnf_pkg_id>',
        'Vnf_imgs': 'vnf_imgs',
        'Vnf_imgsId': 'vnf_imgs/<string:vnf_img_id>',
        'Vnf_imgsIdUpload': 'vnf_imgs/<string:vnf_img_id>/upload',
        'Blueprints': 'blueprints',
        'BlueprintsId': 'blueprints/<string:blueprint_id>',
        'BlueprintsIdArchive': 'blueprints/<string:blueprint_id>/archive',
        'BlueprintsIdUpdate': 'blueprints/<string:blueprint_id>/update',
        'Snapshots': 'snapshots',
        ...
        'LifeCycleChangesNotification': 'vnfs/lifecyclechangesnotification',
        'EventNotification': 'vnfs/eventnotification'
    }
