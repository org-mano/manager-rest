...
class Vnf_pkg(SQLResourceBase):
    __tablename__ = 'vnf_pkgs'
    name = db.Column(db.Text)
...
class Vnf_img(SQLResourceBase):
    __tablename__ = 'vnf_imgs'
    name = db.Column(db.Text)
    vnf_pkg_id = db.Column(db.Text)
    vim_id = db.Column(db.Text)
    status = db.Column(db.Text)
    created_at = db.Column(UTCDateTime, nullable=False, index=True)
